...
function prepareV3ResolvedSchema(copied, version) {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    // channel object
    const channelObject = copied.definitions[`http://asyncapi.com/definitions/${version}/channel.json`];
    if ((_b = (_a = channelObject === null || channelObject === void 0 ? void 0 : channelObject.properties) === null || _a === void 0 ? void 0 : _a.servers) === null || _b === void 0 ? void 0 : _b.items) {
    ...
    if ((_c = operationSchema === null || operationSchema === void 0 ? void 0 : operationSchema.properties) === null || _c === void 0 ? void 0 : _c.channel) {
        operationSchema.properties.channel.$ref = `http://asyncapi.com/definitions/${version}/channel.json`;
    }
    if ((_e = (_d = operationSchema === null || operationSchema === void 0 ? void 0 : operationSchema.properties) === null || _d === void 0 ? void 0 : _d.messages) === null || _e === void 0 ? void 0 : _e.items) {
    ...
    if ((_f = operationReplySchema === null || operationReplySchema === void 0 ? void 0 : operationReplySchema.properties) === null || _f === void 0 ? void 0 : _f.channel) {
        operationReplySchema.properties.channel.$ref = `http://asyncapi.com/definitions/${version}/channel.json`;
    }
    if ((_h = (_g = operationReplySchema === null || operationReplySchema === void 0 ? void 0 : operationReplySchema.properties) === null || _g === void 0 ? void 0 : _g.messages) === null || _h === void 0 ? void 0 : _h.items) {
