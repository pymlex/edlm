...
var SchemaHelpers = (function () {
    ...
    SchemaHelpers.applicatorSchemaName = function (idx, firstCase, otherCases, title) {
        ...
        if (suffix.startsWith(' <anonymous-schema-'))
            suffix = ' Anonymous Schema';
        if (idx === 0) {
    ...
    SchemaHelpers.jsonFieldToSchema = function (value, visitedInPath) {
        var _a, _b, _c, _d;
        var _this = this;
        if (visitedInPath === void 0) { visitedInPath = new Set(); }
        ...
        try {
            ...
            if (Array.isArray(value)) {
                return _c = {
                        type: 'array',
                        items: value.map(function (v) { return _this.jsonFieldToSchema(v, visitedInPath); })
                    },
            ...
            return _d = {
                    type: 'object',
                    properties: Object.entries(value).reduce(function (acc, _a) {
                        var k = _a[0], v = _a[1];
                        acc[k] = _this.jsonFieldToSchema(v, visitedInPath);
                        return acc;
                    }, {})
                },
    ...
    SchemaHelpers.hasRules = function (schema, constraints) {
    ...
    SchemaHelpers.hasConditions = function (schema) {
        var _a, _b, _c;
        var dependentSchemas = this.getDependentSchemas(schema);
        return !!((((_a = schema.oneOf()) === null || _a === void 0 ? void 0 : _a.length) ||
            ((_b = schema.anyOf()) === null || _b === void 0 ? void 0 : _b.length) ||
            ((_c = schema.allOf()) === null || _c === void 0 ? void 0 : _c.length) ||
            schema.not() ||
