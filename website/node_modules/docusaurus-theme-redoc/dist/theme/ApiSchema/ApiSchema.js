...
require("./styles.css");
const ApiSchema = ({ id, spec, pointer, showExample = false, example = showExample, ...rest }) => {
    const specProps = (0, useSpecData_1.useSpecData)(id, spec);
    ...
    return (react_1.default.createElement(styled_components_1.ThemeProvider, { theme: store.options.theme },
        react_1.default.createElement("div", { className: (0, clsx_1.default)([
            ...
            react_1.default.createElement(redoc_1.SchemaDefinition, { parser: store.spec.parser, options: store.options, schemaRef: pointer, showExample: example, ...rest }))));
};
